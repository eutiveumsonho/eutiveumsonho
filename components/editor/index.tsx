...
import { CommandsExtension, Extension } from "@remirror/core";
...
function MarkdownToolbar(props: MarkdownToolbarProps): JSX.Element {
...
function MarkdownTextEditor(props: MarkdownTextEditorProps): JSX.Element {
