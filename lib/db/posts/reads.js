...
/**
 * Searches public/anonymous posts given a query.
 *
 * Uses a standard MongoDB text index rather than Atlas Search ($search),
 * since the self-hosted deployment has no Atlas/mongot search node.
 *
 * @param {string} query
 */
