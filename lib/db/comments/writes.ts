 ...
 */
export async function createComment(data: CommentData): Promise<any> {
 ...
 * @returns {Promise<any>}
 */
export async function deleteComment(commentId: string, postId: string): Promise<any> {
  ...
  return await Promise.all([
    collection.deleteOne({ _id: new ObjectId(commentId) }),
