  ...
  return (
    <div>
      <div>
        <div>
          <h1>
            Privacy Policy of <strong>eutiveumsonho</strong>
          </h1>
        ...
        <div>
          ...
          <p>
            <strong>Owner contact email:</strong> marcelo@eutiveumsonho.com
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            Usage Data, collected automatically when using eutiveumsonho.
            <br />
            Unless specified otherwise, all Data requested by eutiveumsonho is
            mandatory and failure to provide this Data may make it impossible
            for eutiveumsonho to provide its services. In cases where
            eutiveumsonho specifically states that some Data is not mandatory,
            ...
            <br />
            Any use of Cookies – or of other tracking tools — by eutiveumsonho
            or by the owners of third-party services used by eutiveumsonho
          ...
          <p>
            ...
            published or shared through eutiveumsonho.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            charge, involved with the operation of eutiveumsonho
        ...
        <p>
          This section applies to all Users in the European Union, according to
          the General Data Protection Regulation (the &quot;GDPR&quot;), and,
          for such Users, supersedes any other possibly divergent or conflicting
          information contained in the privacy policy. Further details regarding
          the categories of Data processed, the purposes of processing, the
          categories of recipients of the Personal Data, if any, and further
          information about Personal Data can be found in{" "}
          <strong>
        ...
        <p>
          ...
          the Users&apos; request, the Owner will inform them about those
          recipients.
        </p>
        ...
        <div>
          <h2>Further information for Users in Brazil</h2>
          <p>
            ...
            provided by the entity running eutiveumsonho and, if the case may
            be, its parent, subsidiaries and affiliates (for the purposes of
            this section referred to collectively as &quot;we&quot;,
            &quot;us&quot;, &quot;our&quot;).
            <br /> This section applies to all Users in Brazil (Users are
            referred to below, simply as &quot;you&quot;, &quot;your&quot;,
            &quot;yours&quot;), according to the "Lei Geral de Proteção de
            Dados" (the "LGPD"), and for such Users, it supersedes any other
            possibly divergent or conflicting information contained in the
            privacy policy. <br /> This part of the document uses the term
            &quot;personal information&quot; as it is defined in the{" "}
            <strong>LGPD</strong>.
          </p>
          ...
          <p>
            ...
            <br /> In any case, should it be impossible for us to do so,
            we&apos;ll make sure to communicate to you the factual or legal
            reasons that prevent us from immediately, or otherwise ever,
            complying with your requests. In cases where we are not processing
            your personal information, we will indicate to you the physical or
            legal person to whom you should address your requests, if we are in
            the position to do so.
          </p>
          <p>
            In the event that you file an <strong>access</strong> or personal
            information <strong> processing confirmation</strong> request,
            please make sure that you specify whether you&apos;d like your
            personal information to be delivered in electronic or printed form.{" "}
            <br /> You will also need to let us know whether you want us to
            answer your request immediately, in which case we will answer in a
            simplified fashion, or if you need a complete disclosure instead.{" "}
            <br /> In the latter case, we&apos;ll respond within 15 days from
            the time of your request, providing you with all the information on
            the origin of your personal information, confirmation on whether or
          ...
          <p>
            ...
            request, we will make sure to immediately communicate your request
            to other parties with whom we have shared your personal information
            in order to enable such third parties to also comply with your
            request — except in cases where such communication is proven
        ...
        <div>
          ...
          <p>
            ...
            from improper use of eutiveumsonho or the related Services.
            <br />
          ...
          <p>
            ...
            eutiveumsonho may provide the User with additional and contextual
            information concerning particular Services or the collection and
            processing of Personal Data upon request.
          </p>
          <h3>System logs and maintenance</h3>
          <p>
            For operation and maintenance purposes, eutiveumsonho and any
            third-party services may collect files that record interaction with
            eutiveumsonho (System logs) or use other Personal Data (such as the
          ...
          <p>
            ...
            eutiveumsonho and/or - as far as technically and legally feasible -
        ...
        <div>
          <div>
            ...
            <div>
              ...
              <h4>Usage Data</h4>
              <p>
                Information collected automatically through eutiveumsonho (or
                third-party services employed in eutiveumsonho), which can
                include: the IP addresses or domain names of the computers
                utilized by the Users who use eutiveumsonho, the URI addresses
              ...
              <h4>User</h4>
              <p>
                The individual using eutiveumsonho who, unless otherwise
              ...
              <p>
                ...
                eutiveumsonho. The Data Controller, unless otherwise specified,
                is the Owner of eutiveumsonho.
              </p>

              <h4>eutiveumsonho (or this Application)</h4>
              <p>
              ...
              <h4>Service</h4>
              <p>
                The service provided by eutiveumsonho as described in the
              ...
              <p>
                This privacy policy relates solely to eutiveumsonho, if not
        ...
        <div>
          <p>Latest update: September 02, 2023</p>
        </div>
      </div>
    </div>
  );
