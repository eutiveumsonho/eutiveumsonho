export function PrivacyPolicyPt() {
  return (
    <div>
      <h1>
        Política de Privacidade do serviço <strong>eutiveumsonho</strong>
      </h1>

      <p>
        Para receber informações sobre os seus dados pessoais, os propósitos e
        as partes de informação que são compartilhadas, entre em contato com o
        Proprietário.
      </p>

      <h2>Proprietário e Controlador de Dados</h2>
      <p>
        Eu tive um sonho, Avenida Tancredo Neves, 2539, Sala 2609 - CEO Salvador
        Shopping Torre Londres, Caminho das Árvores, Salvador - BA, 41820-021
      </p>
      <p>
      ...
      <p>
        ...
        eutiveumsonho são obrigatórios e a falta de fornecimento destes Dados
        poderá impossibilitar eutiveumsonho de fornecer os seus Serviços. Nos
        casos em que eutiveumsonho afirmar especificamente que alguns Dados não
        forem obrigatórios, os Usuários ficam livres para deixarem de comunicar
        ...
        por eutiveumsonho ou pelos proprietários de serviços terceiros
        utilizados por eutiveumsonho serão para a finalidade de fornecer os
        Serviços solicitados pelo Usuário, além das demais finalidades descritas
        no presente documentoe na Política de Cookies.
      </p>
      <p>
      ...
      <p>
        ...
        <br />O processamento dos Dados é realizado utilizando computadores e
        /ou ferramentas de TI habilitadas, seguindo procedimentos
        organizacionais e meios estritamente relacionados com os fins indicados.
        Além do Proprietário, em alguns casos, os Dados podem ser acessados por
        certos tipos de pessoas encarregadas, envolvidas com a operação deste
        Serviço (eutiveumsonho) (administração, vendas, marketing, administração
      ...
      <p>
        ...
        envolver a transferência dos Dados do Usuário para outro país que não
        seja o seu. Para descobrirem mais sobre o local de processamento de tais
        Dados transferidos os Usuários poderão verificar a seção contendo os
        detalhes sobre o processamento de Dados Pessoais.
      </p>

      <h3>Período de conservação</h3>
      <p>
        Salvo especificação em contrário neste documento, os Dados Pessoais
        serão tratados e armazenados pelo tempo necessário para as finalidades
        para as quais foram coletados, e poderão ser retidos por mais tempo em
        razão de qualquer obrigação legal aplicável ou com base no consentimento
        dos Usuários.
      </p>

      <h2>Informações adicionais para usuários na União Européia </h2>

      <p>
        Esta seção se aplica a todos os Usuários da União Europeia, de acordo
        com o Regulamento Geral de Proteção de Dados (o "GDPR"), e, para esses
        Usuários, substitui qualquer outra informação possivelmente divergente
        ou conflitante contida na política de privacidade. Mais detalhes sobre
        as categorias de Dados processados, as finalidades do processamento, as
        categorias de destinatários dos Dados Pessoais, se houver, e outras
        informações sobre os Dados Pessoais podem ser encontradas na{" "}
        <strong>
          seção intitulada "Informações detalhadas sobre o processamento de
          Dados Pessoais" deste documento
        </strong>
        .
      </p>
      ...
      <h3>Mais informações sobre o tempo de retenção</h3>
      ...
      <p>
        ...
        um prazo maior sempre que o Usuário tiver dado a sua autorização para
        tal processamento, enquanto tal autorização não tiver sido retirada.
        Além disso, o Proprietário poderá ficar obrigado a conservar os Dados
        Pessoais por um prazo maior em todas as ocasiões em que estiver obrigado
        a fazê-lo para o cumprimento de uma obrigação jurídica ou em cumprimento
        de um mandado de uma autoridade.
        <br />
        <br />
      ...
      <h3>
        Os direitos dos Usuários com base no Regulamento Geral de Proteção de
        Dados (GDPR)
      </h3>
      <p>
      ...
      <p>
        Em especial, os Usuários possuem os direitos a fazer o seguinte, dentro
      ...
      <ul>
        <li>
          ...
          Usuários possuem o direito de retirar a sua anuência nos casos em que
          tenham dado a sua anuência anteriormente para o processamento dos seus
          Dados Pessoais.
        </li>
        <li>
        ...
        <li>
          <strong>Acessar os seus Dados.</strong> Os Usuários possuem o direito
          de saber se os seus Dados estão sendo tratados pelo Proprietário,
          obter revelações sobre determinados aspectos do tratamento e conseguir
        ...
        <li>
          ...
          Usuários possuem o direito de restringir o processamento dos seus
          Dados para qualquer outra finalidade que não seja o armazenamento dos
          mesmos.
        </li>
        <li>
          <strong>
          ...
          Os Usuários possuem o direito de obter a eliminação dos seus Dados do
          Proprietário.
        </li>
        <li>
          <strong>
          ...
          estruturado, utilizado comumente e apto a ser lido por máquinas e, se
          for viável tecnicamente, fazer com que estes sejam transmitidos para
          outro controlador sem nenhum empecilho.
        </li>
        <li>
          <strong>Registrar uma reclamação.</strong> Os Usuários possuem o
      ...
      <p>
        ...
        jurídica das transferências de Dados para o exterior, incluindo
        quaisquer organizações internacionais regidas pelo direito internacional
        público ou formadas por dois ou mais países, como a ONU, e sobre as
        medidas de segurança tomadas pelo Proprietário para proteger seus Dados.
      </p>

      <h4>Detalhes sobre o direito de objetar ao processamento</h4>
      <p>
        <strong>
      ...
      <h4>Como exercer estes direitos</h4>
      <p>
        Quaisquer pedidos para exercer os direitos dos Usuários podem ser
        direcionados ao Proprietário através dos dados de contato fornecidos
        neste documento. Tais pedidos são gratuitos e serão atendidos pelo
        Proprietário com a maior brevidade possível e sempre no prazo de um mês,
        fornecendo aos Usuários as informações exigidas por lei. Qualquer
        retificação ou exclusão de Dados Pessoais ou restrição de processamento
        será comunicada pelo Proprietário a cada destinatário, se houver, a quem
        os Dados Pessoais foram divulgados, a menos que isso seja impossível ou
        implique um trabalho desproporcional. A pedido dos Usuários, o
        Proprietário os informará sobre tais destinatários.
      </p>

      <div></div>

      <div>
        <h2>Informações adicionais para Usuários no Brasil</h2>
        <p>
          Esta seção do documento se integra e complementa as informações
          contidas no resto desta política de privacidade e é fornecida pela
          entidade que opera eutiveumsonho e, conforme for o caso, suas
        ...
        <h3>Em que nos embasamos para processar suas informações pessoais</h3>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            fundamentais não prevaleçam sobre tais interesses; e
          </li>
        ...
        <h3>Categorias de informações pessoais processadas</h3>
        <p>
        ...
        <h3>Por que processamos suas informações pessoais</h3>
        <p>
          ...
          processamento de Dados Pessoais" e "As finalidades do processamento"
          neste documento.
        </p>
        ...
        <p>
          ...
          Nos casos em que não estivermos processando suas informações pessoais,
          indicaremos a pessoa física ou jurídica a quem você deve encaminhar
          suas solicitações, se estivermos na posição de fazê-lo.
        </p>
        <p>
          Caso você registre uma solicitação de <strong>acesso</strong> ou de{" "}
          <strong>confirmação de processamento</strong> de informações pessoais,
          certifique-se de especificar se deseja que suas informações pessoais
          sejam entregues em formato eletrônico ou impresso.
          <br />
          Você também precisará nos informar se deseja que respondamos sua
          solicitação imediatamente, sendo que neste caso responderemos de
        ...
        <p>
          Caso você solicite uma{" "}
          <strong>
            retificação, exclusão, anonimato ou bloqueio de informações pessoais
          </strong>
          , comunicaremos imediatamente sua solicitação a outras partes com quem
          compartilhamos suas informações pessoais, a fim de permitir que estes
          terceiros também cumpram sua solicitação – exceto nos casos em que tal
      ...
      <p>
        ...
        In particular, you have the right to request two separate lists from us
        where we disclose:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          a business purpose and the categories of persons to whom it was
      ...
      <p>
        ...
        and repair errors on eutiveumsonho, to detect security incidents and
        protect against fraudulent or illegal activities, to exercise certain
        rights etc.).
      </p>
      <p>
        If no legal exception applies, as a result of exercising your right, we
      ...
      <p>
        However, if you refuse to provide your personal information to us or ask
        us to delete or stop selling your personal information, and that
      ...
      <p>
        ...
        selling your personal information, provided that the financial incentive
        offered is reasonably related to the value of your personal information.
      </p>
      ...
      <p>
        ...
        account with us. We will use any personal information collected from you
        in connection with the verification of your request solely for the
      ...
      <p>
        ...
        you have the right to request that we disclose information beyond the
        12-month period, and we will provide them to you unless doing so proves
      ...
      <h4>
        How we use the data we collect: sharing of your personal data with third
        parties
      </h4>
      ...
      <p>
        ...
        inform you beforehand and will grant your right to opt out of such sale.
      </p>
      ...
      <ul>
        <li>
          <b>access personal data: the right to know.</b> You have the right to
        ...
        <li>
          <b>correct inaccurate personal data.</b> You have the right to request
          that we correct any inaccurate personal data we maintain about you,
          taking into account the nature of the personal data and the purposes
          of the processing of the personal data.
        </li>
        <li>
          <b>request the deletion of your personal data.</b> You have the right
        ...
        <li>
          ...
          , the <b>sale of personal data</b>, or <b>profiling</b> in furtherance
          of decisions that produce legal or similarly significant effects
          concerning you.
        </li>
        <li>
          <b>non-discrimination.</b> We will not discriminate against you for
          exercising your rights under the VCDPA. This means that we will not,
          among other things, deny goods or services, charge you a different
          price, or provide a different level or quality of goods or services
          just because you exercised your consumer privacy rights. However, if
          you refuse to provide your personal data to us or ask us to delete or
          stop selling your personal data, and that personal data or sale is
          necessary for us to provide you with goods or services, we may not be
          able to complete that transaction. To the extent permitted by the law,
          ...
          fee, if you have exercised your right to opt out, or our offer is
      ...
      <p>
        ...
        that the personal data in our possession actually relate to you. In such
        cases, we may request that you provide additional information which is
      ...
      <div>
        <h2>Mais informações para os consumidores de Utah</h2>
        <p>
          This section of the document integrates with and supplements the
          information contained in the rest of the privacy policy and is
          provided by the controller running eutiveumsonho and, if the case may
      ...
      <p>
        ...
        jurídica decorrente de uso indevido deste Serviço (eutiveumsonho) ou dos
        Serviços relacionados.
        <br />O Usuário declara estar ciente de que o Proprietário poderá ser
      ...
      <p>
        ...
        eutiveumsonho poderá fornecer ao Usuário informações adicionais e
        contextuais sobre os serviços específicos ou a coleta e processamento de
        Dados Pessoais mediante solicitação.
      </p>
      <h3>Logs do sistema e manutenção</h3>
      <p>
        Para fins de operação e manutenção, eutiveumsonho e quaisquer serviços
        de terceiros poderão coletar arquivos que gravam a interação com
        eutiveumsonho (logs do sistema) ou usar outros Dados Pessoais (tais como
      ...
      <p>
        ...
        Usuários nesta página e possivelmente dentro deste Serviço
        (eutiveumsonho) e/ou – na medida em que for técnica e juridicamente
        ...
        última modificação informada na parte inferior.
        <br />
        <br />
      ...
      <h2>Informações adicionais para Usuários no Brasil</h2>
      <p>
        Esta seção do documento se integra e complementa as informações contidas
        no resto desta política de privacidade e é fornecida pela entidade que
        opera eutiveumsonho e, conforme for o caso, suas controladoras,
      ...
      <h3>Em que nos embasamos para processar suas informações pessoais</h3>
      <p>
        Podemos processar suas informações pessoais somente se tivermos uma base
        legal para tal processamento. As bases legais são as seguintes:
      </p>
      <ul>
        <li>sua anuência com as respectivas atividades de processamento;</li>
        <li>
        ...
        <li>
          a execução de um contrato e seus procedimentos preliminares, nos casos
          em que você for parte do contrato;
        </li>
        <li>
          o exercício de nossos direitos em processos judiciais, administrativos
          ou de arbitragem;
        </li>
        <li>proteção ou segurança física de você ou de um terceiro;</li>
        <li>
      ...
      <p>
        Para saber mais sobre as bases legais, você pode entrar em contato
        conosco a qualquer momento através dos dados de contato fornecidos neste
        documento.
      </p>

      <h3>Categorias de informações pessoais processadas</h3>
      <p>
        Para saber que categorias de suas informações pessoais são processadas,
        você poderá ler a seção intitulada "Informações detalhadas sobre o
        processamento de Dados Pessoais" neste documento.
      </p>
      ...
      <ul>
        ...
        <li>
          obter o anonimato, bloqueio ou eliminação de suas informações pessoais
          desnecessárias ou em excesso, ou de informações que não estejam sendo
          processadas de acordo com a LGPD;
        </li>
        <li>
          obter informações sobre a possibilidade de fornecer ou recusar sua
          anuência e as respectivas consequências;
      ...
      <h4>Como registrar sua solicitação</h4>
      <p>
        Você poderá registrar sua solicitação expressa de exercer seus direitos
        gratuitamente , em qualquer momento, usando os dados de contato
        fornecidos neste documento ou através de seu representante legal.
      </p>
      ...
      <p>
        ...
        imediatamente, ou de qualquer outra forma, cumprir suas solicitações.
        Nos casos em que não estivermos processando suas informações pessoais,
        indicaremos a pessoa física ou jurídica a quem você deve encaminhar suas
        solicitações, se estivermos na posição de fazê-lo.
      </p>
      <p>
        Caso você registre uma solicitação de <strong>acesso</strong> ou de{" "}
        <strong>confirmação de processamento</strong> de informações pessoais,
        ...
        <br />
        Você também precisará nos informar se deseja que respondamos sua
        solicitação imediatamente, sendo que neste caso responderemos de maneira
        simplificada ou se você precisa de uma resposta completa.
        <br />
        Neste último caso, responderemos no prazo de 15 dias a contar do momento
        de sua solicitação, fornecendo todas as informações sobre a origem de
        suas informações pessoais, confirmação da existência ou não de
      ...
      <p>
        ...
        compartilhamos suas informações pessoais, a fim de permitir que estes
        terceiros também cumpram sua solicitação – exceto nos casos em que tal
        comunicação se provar impossível ou envolver um esforço desproporcional
        de nosso lado.
      </p>

      <h3>
        Transferência de informações pessoais para fora do Brasil permitida por
        lei
      </h3>
      <p>
        Temos permissão para transferir suas informações pessoais para fora do
      ...
      <ul>
        <li>
          quando a transferência for necessária para fins de cooperação jurídica
          internacional entre órgãos públicos de inteligência, investigação e
          Ministério Público, de acordo com os meios legais dispostos no direito
          internacional;
        </li>
        <li>
          quando a transferência for necessária para proteger sua vida ou
        ...
        <li>
          quando a transferência for necessária para a execução de uma política
          pública ou atribuição legal de serviço público;
        </li>
        <li>
          quando a transferência for necessária para o cumprimento de uma
          obrigação legal ou regulamentar, a execução de um contrato ou
      ...
      <h4>Dados de Uso</h4>
      <p>
        As informações coletadas automaticamente através deste eutiveumsonho (ou
        serviços de terceiros contratados neste Serviço (eutiveumsonho)), que
        podem incluir: os endereços IP ou nomes de domínio dos computadores
        utilizados pelos Usuários que utilizam eutiveumsonho, os endereços URI
        (Identificador Uniforme de Recurso), a data e hora do pedido, o método
        utilizado para submeter o pedido ao servidor, o tamanho do arquivo
        recebido em resposta, o código numérico que indica o status do servidor
        de resposta (resultado positivo, erro , etc.), o país de origem, as
        características do navegador e do sistema operacional utilizado pelo
        Usuário, os vários detalhes de tempo por visita (por exemplo, o tempo
        gasto em cada página dentro do aplicativo) e os detalhes sobre o caminho
        seguido dentro da aplicação, com especial referência à sequência de
        páginas visitadas e outros parâmetros sobre o sistema operacional do
        dispositivo e/ou ambiente de TI do Usuário.
      </p>
      <h4>Usuário</h4>
      <p>
        A pessoa que usa eutiveumsonho que, a menos que especificado
      ...
      <p>
        ...
        (eutiveumsonho). O Controlador de Dados, a menos que seja especificado
        de outra forma, é o Proprietário deste Serviço (eutiveumsonho).
      </p>
      ...
      <h4>Serviço</h4>
      <p>
        O serviço fornecido por eutiveumsonho conforme descrito nos termos
      ...
      <p>
        ...
        de múltiplas legislações.
      </p>
      <p>
        Esta política de privacidade se refere somente a eutiveumsonho, se não
        afirmado diferentemente neste documento.
      </p>
      <p>Última atualização: 10 de agosto de 2022</p>
    </div>
  );
}
