  ...
  return (
    <div>
      <div>
        <div>
          <h1>
            Terms and Conditions of <strong>eutiveumsonho</strong>
          </h1>
          <p>These Terms govern</p>
          <ul>
            <li>the use of eutiveumsonho, and,</li>
            <li>
        ...
        <p>Eutiveumsonho is provided by:</p>
        ...
        <p>
          <b>Owner contact email:</b> marcelo@eutiveumsonho.com
        </p>

        <h2 id="what-the-user-should-know-at-a-glance">
        ...
        <ul>
          <li>
            Usage of eutiveumsonho and the Service is age restricted, as
        ...
        <ul>
          <li>
            Minors may access eutiveumsonho and use its Service only under
        ...
        <p>
          ...
          apply generally when using eutiveumsonho.
        </p>
        ...
        <p>
          By using eutiveumsonho, Users confirm to meet the following
          requirements:
        </p>
        <ul>
          <li>
        ...
        <ul>
          <li>Users must be older than 12;</li>
        </ul>

        <ul>
          <li>
            Minors may only use eutiveumsonho under parental or adult
            supervision;
          </li>
        </ul>
        ...
        <p>
          ...
          that meet the highest standards of strength permitted by
          eutiveumsonho.
        </p>
        ...
        <h4 id="conditions-for-account-registration">
          Conditions for account registration
        </h4>
        <p>
          Registration of User accounts on eutiveumsonho is subject to the
        ...
        <h4 id="account-suspension-and-deletion">
        ...
        <h3 id="content-on-this_application">Content on eutiveumsonho</h3>
        <p>
          Unless where otherwise specified or clearly recognizable, all content
          available on eutiveumsonho is owned or provided by the Owner or its
          licensors.
        </p>

        <p>
          The Owner undertakes its utmost effort to ensure that the content
          provided on eutiveumsonho infringes no applicable legal provisions or
        ...
        <h4 id="rights-regarding-content-on-this_application-all-rights-reserved">
          Rights regarding content on eutiveumsonho - All rights reserved
        </h4>
        <p>
        ...
        <p>
          By providing content to eutiveumsonho, Users confirm that they are
          legally allowed to do so and that they are not infringing any
          statutory provisions and/or third-party rights.
        </p>
        <p>
          Further insights regarding acceptable content can be found inside the
          section of these Terms which detail the acceptable uses.
        </p>
        <h4 id="rights-regarding-content-provided-by-users">
          Rights regarding content provided by Users
        </h4>
        <p>
          Users acknowledge and accept that by providing their own content on
          eutiveumsonho they grant the Owner a non-exclusive, fully paid-up and
          royalty-free license to process such content solely for the operation
          and maintenance of eutiveumsonho as contractually required.
        </p>

        <p>
          To the extent permitted by applicable law, Users waive any moral
          rights in connection with content they provide to eutiveumsonho.
        </p>
        <p>
          Users acknowledge, accept and confirm that all content they provide
          through eutiveumsonho is provided subject to the same general
          conditions set forth for content on eutiveumsonho.
        </p>
        <h4 id="liability-for-provided-content">
          Liability for provided content
        </h4>
        <p>
          Users are solely liable for any content they upload, post, share, or
          provide through eutiveumsonho. Users acknowledge and accept that{" "}
          <strong>the Owner does not filter or moderate such content</strong>.
        </p>
        ...
        <p>
          ...
          uploading User access to eutiveumsonho:
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            accessible via eutiveumsonho, may represent a risk for Users, third
        ...
        <p>
          ...
          that have provided such content or that are liable for it, to any
        ...
        <p>
          ...
          provided through eutiveumsonho.
        </p>
        <h4 id="access-to-provided-content">Access to provided content</h4>
        <p>
          Content that Users provide to eutiveumsonho is made available
          according to the criteria outlined within this section.
        </p>
        <h5 id="publicly-available-content">Publicly available content</h5>
        <p>
          Content meant for public availability shall be automatically made
          public on eutiveumsonho upon upload or, at the sole discretion of the
        ...
        <p>
          No personal data, identifier or any other information related to Users
          (such as a User-ID, avatar or nickname etc.) shall appear in
          connection with the content, unless Users decide otherwise on their
          own initiative.
        </p>
        <p>
          Users may (and are encouraged to) check on eutiveumsonho to find
          details of who can access the content they provide.
        </p>
        <h3 id="access-to-external-resources">Access to external resources</h3>
        <p>
          Through eutiveumsonho Users may have access to external resources
        ...
        <p>
          Eutiveumsonho and the Service may only be used within the scope of
        ...
        <p>
          ...
          eutiveumsonho and/or the Service violates no applicable law,
        ...
        <p>
          ...
          <strong>
            ...
            to eutiveumsonho or the Service, terminating contracts, reporting
            any misconduct performed through eutiveumsonho or the Service to the
            competent authorities – such as judicial or administrative
            authorities - whenever Users engage or are suspected to engage in
        ...
        <p>
          ...
          due to or in relation with any culpable violation of these Terms,
        ...
        <p>
          ...
          such as any obligation strictly necessary to achieve the purpose of
          the contract, and/or damages resulting from intent or gross
          negligence, as long as eutiveumsonho has been appropriately and
        ...
        <p>
          ...
          only be liable to the extent of typical and foreseeable damages at the
        ...
        <ul>
          ...
          <li>
            <strong>any errors, mistakes, or inaccuracies of content;</strong>
          </li>
          <li>
            <strong>
        ...
        <p>
          ...
          discontinue the Service altogether. If the Service is discontinued,
          the Owner will cooperate with Users to enable them to withdraw
          Personal Data or information and will respect Users' rights relating
          to continued product use and/or compensation, as provided for by
          applicable law.
        </p>
        ...
        <p>
          ...
          the privacy policy of eutiveumsonho.
        </p>
        ...
        <p>
          ...
          patent rights and design rights related to eutiveumsonho are the
        ...
        <p>
          ...
          appearing in connection with eutiveumsonho are, and remain, the
          exclusive property of the Owner or its licensors and are subject to
          the protection granted by applicable laws or international treaties
        ...
        <p>
          All communications relating to the use of eutiveumsonho must be sent
        ...
        <h4 id="exception-for-consumers-in-europe">
          ...
          <div>
            ...
            <div>
              ...
              <p>
                ...
                eutiveumsonho and/or the Service to Users.
              </p>
              <h4>Service</h4>
              <p>
                The service provided by eutiveumsonho as described in these
                Terms and on eutiveumsonho.
              </p>
              <h4>Terms</h4>
              <p>
                All provisions applicable to the use of eutiveumsonho and/or the
                Service as described in this document, including any other
