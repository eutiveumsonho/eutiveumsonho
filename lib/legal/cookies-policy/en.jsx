export function CookiesPolicyEn() {
  <div>
    <div>
      <div>
        <h2 style="padding-top: 0;">Cookie Policy of eutiveumsonho</h2>
        ...
        <p>
          ...
          User's consent, depending on the applicable law. Whenever consent is
          given, it can be freely withdrawn at any time following the
        ...
        <h3>
          Activities strictly necessary for the operation of eutiveumsonho and
        ...
        <p>
          ...
          via the relevant consent-preferences privacy widget, if available.
        </p>
        <p>
        ...
        <p>
          ...
          However, please note that Trackers help eutiveumsonho to provide a
        ...
        <div>
          ...
          <div>
            ...
            <p>
              ...
              security measures concerning the operation and use of
              eutiveumsonho. The Data Controller, unless otherwise specified, is
              the Owner of eutiveumsonho.
            </p>
            ...
            <h4>Service</h4>
            <p>
              The service provided by eutiveumsonho as described in the relative
            ...
            <p>
              This privacy policy relates solely to eutiveumsonho, if not stated
